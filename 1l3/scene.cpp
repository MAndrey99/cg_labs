...
Scene::Scene(QObject* parent): QGraphicsScene(parent) {
    ...
    painter.drawPolygon(QPolygon(QVector<QPoint>{QPoint(50, 50), QPoint(50, 450), QPoint(50, 250), QPoint(150, 50),
                                                 QPoint(50, 250), QPoint(150, 450), QPoint(50, 250)}));  // K
    painter.drawPolygon(
        QPolygon(QVector<QPoint>{QPoint(260, 450), QPoint(260, 50), QPoint(450, 50), QPoint(260, 50)}));  // Г
